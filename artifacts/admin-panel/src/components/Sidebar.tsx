...
export default function Sidebar({ open, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside className={`
        fixed top-0 left-0 h-full w-64 bg-sidebar border-r border-sidebar-border z-30
      ...
      `}>
        <div className="flex items-center gap-3 px-5 py-5 border-b border-sidebar-border">
          ...
          <div>
            <div className="text-sm font-semibold text-sidebar-foreground">Bot Control</div>
